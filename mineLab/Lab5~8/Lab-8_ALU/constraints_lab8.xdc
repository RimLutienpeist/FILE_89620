...
set_property PACKAGE_PIN AA12 [get_ports {SW1[0]}]
set_property PACKAGE_PIN AA13 [get_ports {SW1[1]}]
set_property PACKAGE_PIN AB10 [get_ports {SW2[0]}]
set_property PACKAGE_PIN AA10 [get_ports {SW2[1]}]
